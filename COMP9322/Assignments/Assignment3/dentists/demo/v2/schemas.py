...
definitions = {'definitions': {'Dentist': {'type': 'object', 'properties': {'id': {'type': 'integer', 'format': 'int64'}, 'name': {'type': 'string', 'description': "Dentist's name"}, 'location': {'type': 'string', 'description': "Dentist's office location"}, 'specification': {'type': 'string', 'description': "Dentist's specification"}, 'phone': {'type': 'string', 'description': "Dentist's phone number"}, 'description': {'type': 'string', 'description': 'Introduction of dentist'}}}, 'AvailableDentists': {'type': 'object', 'properties': {'dentists': {'type': 'array', 'items': {'type': 'string'}, 'description': "Dentist's name"}}}}, 'parameters': {}}

validators = {
}

filters = {
    ('dentist', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/AvailableDentists'}}},
    ('dentist_name', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentist'}}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
}
