...
definitions = {'definitions': {'students': {'type': 'object', 'properties': {'zid': {'type': 'string', 'example': 'z1234567'}, 'name': {'type': 'string', 'example': 'Geralt of Rivia'}}}}, 'parameters': {}}

validators = {
    ('students', 'GET'): {'headers': {'required': [], 'properties': {'Accept': {'type': 'string', 'default': 'application/json'}}}, 'args': {'required': [], 'properties': {'sort': {'type': 'string', 'default': '+name'}}}},
    ('students', 'POST'): {'json': {'$ref': '#/definitions/students'}},
}

filters = {
    ('students', 'GET'): {200: {'headers': None, 'schema': {'type': 'array', 'items': {'$ref': '#/definitions/students'}}}},
    ('students', 'POST'): {200: {'headers': None, 'schema': None}},
}
